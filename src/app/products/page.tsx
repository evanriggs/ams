                ...
                >
                  ...
                  <div className="relative h-48 bg-gradient-to-br from-ocean-foam to-ocean-light overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <svg className="w-20 h-20 text-ocean-mid/30" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Featured badge */}
                    {product.featured && (
                      <div className="absolute top-3 right-3 px-2 py-1 bg-coral text-white text-xs font-bold rounded-full">
                        Featured
                      </div>
                    )}
                  </div>
